...
def render_knowledge_report(
    ...
    if total_changes > 0 and not baseline_created:
        lines.append("> **Note:** This report is generated by AI and may contain errors.")
        lines.append("> Please verify any reported changes against the actual website before acting on them.")
        lines.append("")
